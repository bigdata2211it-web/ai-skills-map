...
name: skills-map
description: |
  Index/map of AI agent skills published under GitHub user bigdata2211it-web.
  For each skill: a link to its GitHub repo and a one-line description.
  Triggers on "what skills are there", "show me all skills", "give me the
  github link for skill X".
---
